...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    ...
    desc_cat: function desc_cat() {
      var _this$$page$props$ite3;

      return ((_this$$page$props$ite3 = this.$page.props.item) === null || _this$$page$props$ite3 === void 0 ? void 0 : _this$$page$props$ite3.desc_cat) || "";
    }
  }
});
...
/* harmony import */ var _FlashMessage_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./FlashMessage.vue */ "./resources/js/Shared/FlashMessage.vue");
//
//
//
//
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    ...
    FlashMessage: _FlashMessage_vue__WEBPACK_IMPORTED_MODULE_1__.default
  }
});
...
var render = function() {
  ...
  return _c("article", { staticClass: "page" }, [
    _c("div", { staticClass: "inner" }, [
      ...
      _vm._v(" "),
      _c("p", { staticClass: "municipi" }, [_vm._v(_vm._s(_vm.municipi))]),
      _vm._v(" "),
      _c("p", { staticClass: "desc" }, [_vm._v(_vm._s(_vm.desc_cat))])
    ])
  ])
}
var staticRenderFns = []
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "flash" }, [
    _vm.flash.success
      ? _c("div", [_vm._v(_vm._s(_vm.flash.success))])
      : _vm._e(),
    _vm._v(" "),
    _vm.flash.error ? _c("div", [_vm._v(_vm._s(_vm.flash.error))]) : _vm._e()
  ])
}
var staticRenderFns = []
render._withStripped = true
      ...
      _c("header", [
        ...
        _c(
          ...
          [
            ...
            _vm._v(" "),
            !_vm.$page.props.user
              ? _c("custom-link", { attrs: { href: _vm.$route("login") } }, [
                  _vm._v("\n        Iniciar Sessió\n      ")
                ])
              : _c("custom-link", { attrs: { href: _vm.$route("logout") } }, [
                  _vm._v("\n        Tancar Sessió\n      ")
                ])
          ],
          1
